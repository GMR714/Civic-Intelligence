...
function ProposalFeedbackSummary() {
            ...
            {[
              {
                ...
                value: proposal.dimensionalFeedback.fairness,
                color: "#00FF66",
              },
              {
                label: "Viabilidade",
                value: proposal.dimensionalFeedback.feasibility,
                color: "#E1FF00",
              },
              {
                label: "Impacto Econômico",
                value: proposal.dimensionalFeedback.economicImpact,
                color: "#FF00AA",
              },
              {
                label: "Impacto Ambiental",
                value: proposal.dimensionalFeedback.environmentalImpact,
                color: "#00BFFF",
              },
            ].map((dim) => (
